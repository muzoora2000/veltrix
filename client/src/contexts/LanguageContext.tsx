...
const UI_STRINGS: Record<string, Record<string, string>> = {
  'nav.home': {
    ...
    nyo: 'Eka', ttj: 'Eka', laj: 'Ot', alz: 'Ot', myx: 'Omwi', kdj: 'Awi', spy: 'Yonet', koo: 'Eka',
  },
  'nav.dashboard': {
    en: 'Dashboard', lug: 'Ddundi', nyn: 'Ekaragwe', teo: 'Ekaragwe', luo: 'Karaja',
    lgg: 'Dasi', xog: 'Dasi', cgg: 'Ekaragwe', ach: 'Ducu', swa: 'Dashibodi',
    nyo: 'Ekaragwe', ttj: 'Ekaragwe', laj: 'Deski', alz: 'Deski', myx: 'Dashi', kdj: 'Deski', spy: 'Dashi', koo: 'Ekaragwe',
  },
  'nav.reports': {
    en: 'Reports', lug: 'Lipooti', nyn: 'Embaruha', teo: 'Iparit', luo: 'Tedo',
    lgg: 'Riipota', xog: 'Lipooti', cgg: 'Embaruha', ach: 'Tedo', swa: 'Ripoti',
    nyo: 'Oburuha', ttj: 'Embaruha', laj: 'Lipooti', alz: 'Riport', myx: 'Lipooti', kdj: 'Riipota', spy: 'Ripooto', koo: 'Oburuha',
  },
  'nav.tracking': {
  ...
  'common.offline': {
    ...
    spy: 'Mam simu. Ibiit bic naa kusync.',
    koo: 'Tohaire. Ebyahinduka bija kusync nga womine.',
  },
  'report.title': {
    ...
    myx: 'Siima Lipooti', kdj: 'Ikar Riipota', spy: 'Tun Ripooto', koo: 'Kureeta Oburuha',
  },
  'report.description': {
    ...
    kdj: 'Ikir aito luo', spy: 'Nyoru imet ko wendi anee yom kobil',
    koo: "Nyetoora eky'oraba oba kuhurira orurari",
  },
  'report.voice': {
    ...
    myx: 'Oyize Eddoboozi', kdj: 'Ikir Aitu', spy: 'Yom Kobil', koo: 'Kuhurira Orurari',
  },
  'report.type': {
    ...
    nyo: 'Ekika', ttj: 'Ekika', laj: 'Kit', alz: 'Kit', myx: 'Ekika', kdj: 'Aibe', spy: 'Kibwech', koo: 'Ekika',
  },
  'report.location': {
    en: 'Location', lug: 'Walawo', nyn: 'Aha', teo: 'Ka', luo: 'Wang',
    lgg: 'Lu', xog: 'Walawo', cgg: 'Aha', ach: 'Wang', swa: 'Mahali',
    nyo: 'Aha', ttj: 'Aha', laj: 'Kabedo', alz: 'Kakuot', myx: 'Walawo', kdj: 'Ka', spy: 'Iman', koo: 'Aha',
  },
  'report.district': {
    ...
    myx: 'Disitulikiti', kdj: 'Disitulikiti', spy: 'Distrikto', koo: 'Disitulikiti',
  },
  'report.subcounty': {
    ...
    myx: 'Ggombolola', kdj: 'Sub-county', spy: 'Sub-county', koo: 'Sub-county',
  },
  'report.village': {
    en: 'Village', lug: 'Kyalo', nyn: 'Omugyenge', teo: 'Ader', luo: 'Gweng',
    lgg: 'Anga', xog: 'Kyalo', cgg: 'Omugyenge', ach: 'Gweng', swa: 'Kijiji',
    nyo: 'Omugyenge', ttj: 'Omugyenge', laj: 'Gweng', alz: 'Wang', myx: 'Kyalo', kdj: 'Ader', spy: 'Soget', koo: 'Omugyenge',
  },
  'report.photo': {
    ...
    myx: 'Funa Ekifaananyi', kdj: 'Ikir Foto', spy: 'Bo Foto', koo: 'Gambeera',
  },
  'report.anonymous': {
    ...
    myx: 'Siima Lipooti Mu Kukyama', kdj: 'Ikar Riipota Kona', spy: 'Tun Ripooto Komanech', koo: 'Kureeta Oburuha Ntama',
  },
  'report.track': {
    ...
    myx: 'Londolola Lipooti Yange', kdj: 'Ikir Riipota Ka', spy: 'Luwan Ripooto Koi', koo: 'Kulondoola Oburuha',
  },
  'report.SMS': {
    ...
    myx: 'Siima SMS', kdj: 'Ikar SMS', spy: 'Tun SMS', koo: 'Kureeta SMS',
  },
  'report.whatsapp': {
    ...
    myx: 'Siima WhatsApp', kdj: 'Ikar WhatsApp', spy: 'Tun WhatsApp', koo: 'Kureeta WhatsApp',
  },
  'report.phone': {
    ...
    alz: 'Yer Simu Toll-Free', myx: 'Yita Toll-Free', kdj: 'Yer Simu Toll-Free', spy: 'Yer Simu Toll-Free', koo: 'Yita Toll-Free',
  },
  'auth.login': {
    en: 'Login', lug: 'Yingira', nyn: 'Kwinyura', teo: 'Ilosi', luo: 'Donjo',
    lgg: 'Login', xog: 'Yingira', cgg: 'Kwinyura', ach: 'Donjo', swa: 'Ingia',
    nyo: 'Kwinyura', ttj: 'Kwinyura', laj: 'Donyo', alz: 'Donjo', myx: 'Yingira', kdj: 'Ilosi', spy: 'Yom', koo: 'Kwinyura',
  },
  'auth.register': {
    en: 'Register', lug: 'Wewandise', nyn: 'Kwiyandiha', teo: 'Ikir', luo: 'Ndik',
    lgg: 'Rijista', xog: 'Wewandise', cgg: 'Kwiyandiha', ach: 'Ndik', swa: 'Jisajili',
    nyo: 'Kwiyandiha', ttj: 'Kwiyandiha', laj: 'Ndik', alz: 'Ndik', myx: 'Wewandise', kdj: 'Ikir', spy: 'Ndik', koo: 'Kwiyandiha',
  },
  'auth.email': {
    en: 'Email', lug: 'Imeyiro', nyn: 'Email', teo: 'Email', luo: 'Email',
    lgg: 'Email', xog: 'Imeyiro', cgg: 'Email', ach: 'Email', swa: 'Barua pepe',
    nyo: 'Email', ttj: 'Email', laj: 'Email', alz: 'Email', myx: 'Imeyiro', kdj: 'Email', spy: 'Email', koo: 'Email',
  },
  'auth.password': {
    ...
    nyo: 'Ekihisho', ttj: 'Ekihisho', laj: 'Mung', alz: 'Mung', myx: 'Ekinyigi Kyama', kdj: 'Ekihisho', spy: 'Choraan', koo: 'Ekihisho',
  },
  'auth.language': {
    ...
    myx: "Olulimi Lw'oyagala", kdj: 'Akaidi', spy: 'Kobil Koi', koo: "Orurimi Orw'orahenda",
  },
  'auth.phone': {
    ...
    myx: 'Enamba ya Simu', kdj: 'Simu Namba', spy: 'Simu Namba', koo: 'Enamba ya Simu',
  },
  'auth.name': {
    ...
    nyo: 'Eizina', ttj: 'Eizina', laj: 'Nying', alz: 'Nying', myx: 'Erinya', kdj: 'Ekon', spy: 'Raran', koo: 'Eizina',
  },
  'chat.title': {
    ...
    myx: 'Muyambi wa Hydro AI', kdj: 'Muyambi wa Hydro AI', spy: 'Muyambi wa Hydro AI', koo: 'Omuhwezi wa Hydro AI',
  },
  'chat.placeholder': {
    ...
    kdj: 'Ikir ekibuuzo...',
    spy: 'Boru ekibuuzo mu kobil...',
    koo: 'Buuza ekibuuzo mu rurimi orwona...',
  },
  'chat.send': {
    en: 'Send', lug: 'Tuma', nyn: 'Kohereza', teo: 'Ikir', luo: 'Cuno',
    lgg: 'Tuma', xog: 'Tuma', cgg: 'Kohereza', ach: 'Cuno', swa: 'Tuma',
    nyo: 'Kohereza', ttj: 'Kohereza', laj: 'Cwalo', alz: 'Cwal', myx: 'Tuma', kdj: 'Ikar', spy: 'Tun', koo: 'Kohereza',
  },
  'chat.voice': {
    en: 'Voice Message', lug: 'Ebboozi', nyn: 'Orurari', teo: 'Aitu', luo: 'Dwoko',
    lgg: 'Voisi', xog: 'Ebboozi', cgg: 'Orurari', ach: 'Dwoko', swa: 'Sauti',
    nyo: 'Orurari', ttj: 'Orurari', laj: 'Dwoko', alz: 'Dwoko', myx: 'Eddoboozi', kdj: 'Aitu', spy: 'Kobil', koo: 'Orurari',
  },
  'status.submitted': {
    en: 'Submitted', lug: 'Kuwawo', nyn: 'Kureetwa', teo: 'Ikir', luo: 'Ochuk',
    lgg: 'Tumawa', xog: 'Kuwawo', cgg: 'Kureetwa', ach: 'Ochuk', swa: 'Imewasilishwa',
    nyo: 'Kureetwa', ttj: 'Kureetwa', laj: 'Okicwalo', alz: 'Ocwalo', myx: 'Waweebwa', kdj: 'Iparit', spy: 'Ochebo', koo: 'Kureetwa',
  },
  'status.investigating': {
    ...
    myx: 'Kupeereza', kdj: 'Aipar', spy: 'Tyo ka nono', koo: 'Okushoroma',
  },
  'status.assigned': {
    ...
    nyo: 'Kuheerwa', ttj: 'Kuheerwa', laj: 'Omiye', alz: 'Omiye', myx: 'Weeberwa', kdj: 'Ikir', spy: 'Omiye', koo: 'Kuheerwa',
  },
  'status.resolved': {
    ...
    nyo: 'Kuharurwa', ttj: 'Kuharurwa', laj: 'Otum', alz: 'Otum', myx: 'Kutereeza', kdj: 'Aibuin', spy: 'Otum', koo: 'Kuharurwa',
  },
  'status.escalated': {
    ...
    myx: 'Yongerwa', kdj: 'Ikwan', spy: 'Owilo Malo', koo: 'Kureetwa Hembega',
  },
  'incident.water_contamination': {
    ...
    myx: 'Okufuula Amakasi', kdj: 'Ngikai Taone', spy: 'Met Otaone', koo: 'Okutamya Amazi',
  },
  'incident.broken_water_point': {
    ...
    myx: 'Ettabi Lyamakasi Limenyese', kdj: 'Ngikai Aballe', spy: 'Kabedo Pa Met Aballe', koo: "Eky'omwisho Kyamagara",
  },
  'incident.flooding': {
    ...
    myx: 'Amataba', kdj: 'Ngikai Laro', spy: 'Met Olaro', koo: 'Emataba',
  },
  'incident.sewage_leak': {
    ...
    laj: 'Nyo Ojwayo', alz: 'Nyo Ojwayo', myx: "Okuseseeka Kw'ekivundu", kdj: 'Nyo Ojwayo', spy: 'Nyo Ojwayo', koo: "Okusaasaana Kw'ekivundu",
  },
  'incident.illegal_dumping': {
    ...
    myx: "Okuteguka Amateeka", kdj: 'Kwero Marac', spy: 'Tun Kwere Marac', koo: 'Okutegura Amateeka',
  },
  'incident.pollution': {
    en: 'Pollution', lug: 'Okufuula', nyn: 'Okutamya', teo: 'Aipi', luo: 'Chilo',
    lgg: 'Polushon', xog: 'Okufuula', cgg: 'Okutamya', ach: 'Chilo', swa: 'Uchafuzi',
    nyo: 'Okutamya', ttj: 'Okutamya', laj: 'Taone', alz: 'Taone', myx: 'Okufuula', kdj: 'Taone', spy: 'Taone', koo: 'Okutamya',
  },
  'incident.environmental_hazard': {
    ...
    laj: 'Arem me Lobo', alz: 'Arem me Lobo', myx: 'Akabi mu Bikolwa', kdj: 'Arem me Ka', spy: 'Arem me Iman', koo: 'Akabi',
  },
  'incident.infrastructure_damage': {
    ...
    myx: 'Okwonona Ebyuma', kdj: 'Aibuin', spy: 'Balle Marac', koo: 'Okwonona',
  },
  'incident.disease_report': {
    ...
    myx: 'Obulwadde / Bwanguzi', kdj: 'Ngidwari / Abui', spy: 'Ng\'alal / Sowondo Ripooto', koo: 'Endwara / Obulwadde',
  },
  'alert.success.report': {
    ...
    spy: 'Ripooto ochebo maber!',
    koo: 'Oburuha bwawe ehareetwa!',
  },
  'alert.error.report': {
    ...
    spy: 'Ripooto pe ochebo. Mising.',
    koo: 'Ensobi mukureeta. Ija.',
  },
  'alert.success.translate': {
    ...
    myx: 'Ekivvuunulwa', kdj: 'Okitroco maber', spy: 'Iboisiet', koo: 'Ekyahindurwa',
  },
};
