...
export default function ChatBot() {
  ...
  return (
    <>
      <button
        onClick={() => setOpen(o => !o)}
        className="flex fixed bottom-6 right-6 z-50 w-14 h-14 rounded-2xl shadow-2xl items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95"
